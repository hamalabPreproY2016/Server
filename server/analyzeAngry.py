...
def analyzeSensor(heart_arr, emg_arr, voice_path, face_path, mve) :
    ...
    ## 音声を解析
    voice_enabled, voice_angry = vokaturi.analuze(voice_path)
    ## 表情を解析
...
def analyzeAngry(heart_angry, emg_angry, emg_enabled, voice_angry, voice_enabled, face_angry, face_enabled) :
    ...
    body_angry, look_angry = angry_predict.angry_predict(heart_angry, emg_angry, emg_enabled, face_angry, face_enbaled, voice_angry, voice_enabled)
    ## ギャップの有無を求める 
